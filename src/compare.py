...
key0 = Key("Key0" , ["Name"] , [jellyfish.nysiis] , [2])
keys.append(key0)
key1 = Key("Key1" , ["Age"] , [str] , [2])
keys.append(key1)
key2 = Key("Key2" , ["Surname"] , [jellyfish.metaphone] , [2])
keys.append(key2)
key3 = Key("Key3" , ["Surname" , "Balance" , "Date Joined" , "Job Classification" , "Name"] , [jellyfish.soundex , str , jellyfish.metaphone , jellyfish.nysiis , str] , [3 , 8 , 8 , 5 ,8])
keys.append(key3)
key4 = Key("Key4" , ["Date Joined" , "Name" , "Balance" , "Age" , "Gender" , "Surname" , "Job Classification" , "Region"] , [jellyfish.metaphone , str , jellyfish.metaphone , jellyfish.soundex , jellyfish.nysiis , jellyfish.metaphone , jellyfish.soundex , str , str] , [3 , 7 , 7 , 7 ,9 , 4 , 6 , 2])
keys.append(key4)

for key in keys:
    for index , row in data.iterrows():
        data.at[index , key.block] = key.Keyv(row=row)
